            ...
            <div class="center" style="padding: 2rem; margin: 0 auto; max-width: 800px;">
                ...
                <form action="{{ route('activities.store') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        <label for="title" style="float: left; display: block; margin-bottom: 5px;">Title</label>
                    ...
                    <div class="form-group">
                        <label for="photo" style="float: left; display: block; margin-bottom: 5px;">Photo</label>
                                ...
                                <div style="flex: 1;">
                                    @if ($activity->photo)
                                        <a href="/activities/{{ rawurlencode($activity->title) }}">
                                            <img src="{{ asset($activity->photo) }}" alt="{{ asset($activity->title) }}"
